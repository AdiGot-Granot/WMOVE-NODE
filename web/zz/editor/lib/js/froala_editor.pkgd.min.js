! function (n) {
  ...
  s.DEFAULTS = {
    initOnClick: !1,
    pluginsEnabled: null
  }, s.MODULES = {}, s.PLUGINS = {}, s.VERSION = "2.9.0", s.INSTANCES = [], s.OPTS_MAPPING = {}, s.SHARED = {}, s.ID = 0, s.prototype._init = function () {
  ...
  if (be.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", be.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", be.FE.LinkRegExTLD = "((" + be.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", be.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExWWW = "(www\\." + be.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", be.FE.LinkRegEx = "(" + be.FE.LinkRegExTLD + "|" + be.FE.LinkRegExHTTP + "|" + be.FE.LinkRegExWWW + "|" + be.FE.LinkRegExAuth + ")" + be.FE.LinkRegExEnd, be.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], be.FE.MAIL_REGEX = /.+@.+\..+/i, be.FE.MODULES.helpers = function (a) {
      ...
      return {
        place: function (e, t, n) {
          ...
          try {
            ...
            if (o.collapse(t), o.insertNode(be('<span class="fr-marker" data-id="' + n + '" data-type="' + t + '" style="display: ' + (d.browser.safari ? "none" : "inline-block") + '; line-height: 0;">' + be.FE.INVISIBLE_SPACE + "</span>", d.doc)[0]), !0 === t)
              for (a = (r = d.$el.find('span.fr-marker[data-type="true"][data-id="' + n + '"]').get(0)).nextSibling; a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;) be(a).remove(), a = r.nextSibling;
            if (!0 === t && !e.collapsed) {
        ...
        split: function () {
          ...
          if (t || (t = d.node.blockParent(e)) && "LI" != t.tagName && (t = null), t)
            if (d.node.isBlock(t) && d.node.isEmpty(t)) "LI" != t.tagName || t.parentNode.firstElementChild != t || d.node.isEmpty(t.parentNode) ? be(t).replaceWith('<span class="fr-marker"></span>') : be(t).append('<span class="fr-marker"></span>');
            else if (d.cursor.isAtStart(e, t)) be(t).before('<span class="fr-marker"></span>'), be(e).remove();
          else if (d.cursor.isAtEnd(e, t)) be(t).after('<span class="fr-marker"></span>'), be(e).remove();
          else {
            ...
            try {
              ...
              if (i.nextSibling == o || o.nextSibling == i) {
                ...
                if (m && m.nodeType == Node.TEXT_NODE)
                  for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE;) m.previousSibling.textContent = m.previousSibling.textContent + m.textContent, m = m.previousSibling, be(m.nextSibling).remove();
                ...
                if (v && v.nodeType == Node.TEXT_NODE)
                  for (; v && v.nextSibling && v.nextSibling.nodeType == Node.TEXT_NODE;) v.nextSibling.textContent = v.textContent + v.nextSibling.textContent, v = v.nextSibling, be(v.previousSibling).remove();
      ...
      return {
        ...
        remove: function () {
          ...
          for (t = 0; t < i.length; t++)
            for (var a = i[t]; !(n(a) || T.node.isBlock(a.parentNode) || T.$el.is(a.parentNode) || T.node.hasClass(a.parentNode, "fr-inner"));) be(a.parentNode).before(a);
          ...
          if (function () {
              for (var e = T.$el.find(".fr-marker"), t = 0; t < e.length; t++)
                if (be(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
              return !0
            }()) {
            ! function e(t, n) {
            ...
            if (l.length) T.$el.find(".fr-marker").remove(), l.append(be.FE.INVISIBLE_SPACE + be.FE.MARKERS).removeAttr("data-first"), l.attr("data-text") && l.replaceWith(l.html());
            else
                ...
                if (f) {
                  if (d && (!c || c != f)) {
                    ...
                    if (p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), u && 0 <= ["UL", "OL"].indexOf(u.tagName) && (g = !(u = null)), be(d).after(f), p != u)
                      if (null != p || h)
                        if (null != u || g || 0 !== be(p).parentsUntil(T.$el, "table").length) p && u && 0 === be(p).parentsUntil(T.$el, "table").length && 0 === be(u).parentsUntil(T.$el, "table").length && 0 === be(p).find(u).length && 0 === be(u).find(p).length && (be(p).append(be(u).html()), be(u).remove());
                        else {
        ...
        lists: function () {
          ...
          function () {
            for (var e = c.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
              for (var n = c.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName ? (r || (r = be("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
          }(),
          function () {
            var e, t, n;
            do {
          ...
          function () {
            for (var e = c.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
              var n = e[t];
              if (c.node.isFirstSibling(n)) be(n).before("<br/>");
      ...
      return {
        ...
        get: function (e, t) {
          ...
          if (x.node.isEmpty(x.el)) x.opts.fullPage && (n = w(x.iframe_document), n += "<html" + x.node.attributes(x.$html.get(0)) + ">" + x.$html.find("head").get(0).outerHTML + "<body></body></html>");
      ...
      return {
        _startEnter: function (e) {
          ...
          if (g.node.isEmpty(n, !0) && r) {
            ...
            var d = "";
            for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + be.FE.MARKERS + "<br>" + o : a ? s + "<" + a + ">" + be.FE.MARKERS + "<br></" + a + ">" + o : s + be.FE.MARKERS + "<br>" + o;
        ...
        _del: function (e) {
          ...
          if (r) {
            ...
            if (s == g.el) return !1;
            if (s = s.nextSibling, g.node.isBlock(s)) be.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (be(e).replaceWith(be.FE.MARKERS), (t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), be(n).append(be(s).html()), be(s).remove());
            else
              for ((t = g.node.contents(n)).length && "BR" == t[t.length - 1].tagName && be(t[t.length - 1]).remove(), be(e).replaceWith(be.FE.MARKERS); s && !g.node.isBlock(s) && "BR" != s.tagName;) be(n).append(be(s)), s = s.nextSibling
          }
        }
      }
        ...
        if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
          ...
          if (n.nodeType == Node.TEXT_NODE) {
            ...
            if (0 === n.textContent.length)
              if (a && u.opts.keepFormatOnDelete) be(n).after(be.FE.INVISIBLE_SPACE + be.FE.MARKERS);
            ...
            } else be(n.parentNode).after(be.FE.MARKERS), be(n.parentNode).remove();
            else be(n).after(be.FE.MARKERS)
          ...
          if (u.node.isDeletable(n)) be(e).replaceWith(be.FE.MARKERS), be(n).remove();
          else if (u.node.isEmpty(n) && !u.node.isList(n)) be(n).remove(), be(e).replaceWith(be.FE.MARKERS);
        else {
      ...
      function l(e) {
        ...
        if (null !== n) {
          ...
          if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && a && be.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0)
            if (u.node.isDeletable(a)) be(a).remove(), be(e).replaceWith(be.FE.MARKERS);
            else if (u.node.isBlock(a) && u.node.isEditable(a))
            if (u.node.isList(a))
              if (u.node.isEmpty(n, !0)) be(n).remove(), be(a).find("li:first").prepend(be.FE.MARKERS);
              else {
      ...
      function n(e) {
        ...
        if ("BR" == (n = n.nextSibling).tagName && u.node.isEditable(n))
          ...
          else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && be.FE.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && be(n).remove(), l(e));
          return
        }
        if (!u.node.isBlock(n) && u.node.isEditable(n)) {
          ...
          if (u.node.isDeletable(n)) be(e).replaceWith(be.FE.MARKERS), be(n).remove();
          else if (u.node.isList(n)) e.previousSibling ? (be(n).find("li:first").prepend(e), u.cursorLists._backspace(e)) : (be(n).find("li:first").prepend(be.FE.MARKERS), be(e).remove());
      ...
      function p(e, t, n) {
        ...
        if (null == i)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? be(e).replaceWith("<" + r + ">" + be.FE.MARKERS + "<br></" + r + ">") : !e.previousSibling || be(e.previousSibling).is("br") || e.nextSibling ? be(e).replaceWith("<br>" + be.FE.MARKERS) : be(e).replaceWith("<br>" + be.FE.MARKERS + "<br>");
        else {
          var a = e,
            o = "";
      ...
      function m(e, t, n) {
        ...
        if (null == r) u.html.defaultTag() && e.parentNode === u.el ? be(e).replaceWith("<" + u.html.defaultTag() + ">" + be.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || be(e).after("<br>"), be(e).replaceWith("<br>" + be.FE.MARKERS));
        else {
          var i = e,
            a = "";
          ...
          if ("BLOCKQUOTE" == r.tagName)
            if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (be(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && be(e.nextSibling).remove()), t) a = o + a + be.FE.MARKERS + s;
            else {
      ...
      return {
        enter: function (t) {
          ...
          0 < be(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), be(n).parentsUntil(u.$el, "TD, TH").length && (r = !1), a(n) ? !s(n) || t || r ? p(n, t, r) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || r ? function e(t, n, r) {
            ...
            if (null == a)(i = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? be(t).replaceWith("<" + i + ">" + be.FE.MARKERS + "<br></" + i + ">") : be(t).replaceWith("<br>" + be.FE.MARKERS);
            else {
              if (u.node.isBlock(a))
                if ("PRE" == a.tagName && (n = !0), n) be(t).remove(), be(a).prepend("<br>" + be.FE.MARKERS);
                else {
          ...
          return a(t) ? e = c(t) : o(t) ? s(t) && h(t, be(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function (e) {
            ...
            if (null !== n) {
              ...
              if (u.node.isBlock(n) && u.node.isEditable(n) && o && be.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0)
                if (u.node.isDeletable(o)) be(o).remove(), be(e).replaceWith(be.FE.MARKERS);
                else if (u.node.isEditable(o))
                if (u.node.isBlock(o))
                  if (u.node.isEmpty(o) && !u.node.isList(o)) be(o).remove(), be(e).after(u.opts.keepFormatOnDelete ? be.FE.INVISIBLE_SPACE : "");
                  else {
                    ...
                    if (u.node.isEmpty(n)) be(e).remove(), u.selection.setAtEnd(o, !0);
                    else {
        ...
        del: function () {
          ...
          if (u.el.normalize(), a(e))
            if (s(e))
              if (0 === be(e).parents("li:first").find("ul, ol").length) u.cursorLists._del(e);
              else {
      ...
      function m(e, t, n) {
        if (e) {
          ...
          if (e) {
            ...
            if (i)(be(i).find(".fr-marker").length || "UL" == i.tagName || "OL" == i.tagName) && m(i.firstChild, t, n);
            else {
              for (var o = r.get(0).parentNode; o && !o.nextSibling && !g.node.isElement(o);) o = o.parentNode;
              if (o) {
                for (var s = o.nextSibling;
        ...
        for (var i = !0; i;) {
          ...
          for (var a = g.node.contents(t.get(0)), o = 0; o < a.length; o++) {
            ...
            if (g.node.hasClass(s, "fr-marker")) n = (n + 1) % 2;
              ...
              if (0 < be(s).find(".fr-marker").length) n = e(be(s), n, r, i);
              else {
      ...
      function t(e, t) {
        ...
        if (g.selection.isCollapsed()) {
          ...
          if (g.node.openTagString(l.get(0)) == '<span style="' + e + ": " + l.css(e) + ';">') {
            if (g.node.isEmpty(l.get(0))) s = be('<span style="' + e + ": " + t + ';">' + be.FE.INVISIBLE_SPACE + be.FE.MARKERS + "</span>"), l.replaceWith(s);
            else {
              var d = {};
      ...
      function d(e, t, n) {
        ...
        if ("string" == typeof c && (e = c), "" !== e) {
          ...
          else b.opts.enter == be.FE.ENTER_P && 1 == f.childNodes.length && "P" == f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
      ...
      return {
        ...
        get: function (e) {
          ...
          if (!r)
            for (var t in r = {}, be.FE.SHORTCUTS_MAP) be.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= s.opts.shortcutsEnabled.indexOf(be.FE.SHORTCUTS_MAP[t].cmd) && (r[be.FE.SHORTCUTS_MAP[t].cmd + "." + (be.FE.SHORTCUTS_MAP[t].val || "")] = {
      ...
      return {
        create: function (n) {
          ...
          if (void 0 !== r) {
            ...
            r.FA5NAME || (r.FA5NAME = r.NAME), t && (t = be.FE.ICON_TEMPLATES[t]) && (e = t.replace(/\[([a-zA-Z0-9]*)\]/g, function (e, t) {
    ...
    //  original
    // be.FE.TOOLBAR_BUTTONS = ["fullscreen", "bold", "italic", "underline", "strikeThrough", "subscript", "superscript", "|", "fontFamily", "fontSize", "color", "inlineClass", "inlineStyle", "lineHeight", "|", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "-", "insertLink", "insertImage", "insertVideo", "embedly", "insertFile", "insertTable", "|", "emoticons", "fontAwesome", "specialCharacters", "insertHR", "selectAll", "clearFormatting", "|", "print", "getPDF", "spellChecker", "help", "html", "|", "undo", "redo"], 
    // be.FE.TOOLBAR_BUTTONS_MD = null, be.FE.TOOLBAR_BUTTONS_SM = ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"], 
    // be.FE.TOOLBAR_BUTTONS_XS = ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo"], 
    // 
    // my edited lines  START
    be.FE.TOOLBAR_BUTTONS = ["fullscreen", "bold", "italic", "underline", "|", "fontFamily", "fontSize", "color", "lineHeight", "|", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "-", "insertLink", "insertImage", "embedly", "insertTable", "|", "fontAwesome", "insertHR", "selectAll", "|", "print", "spellChecker", "help", "html", "|", "undo", "redo"],
    be.FE.TOOLBAR_BUTTONS_MD = null, be.FE.TOOLBAR_BUTTONS_SM = ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"],
    be.FE.TOOLBAR_BUTTONS_XS = ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo"],
    // End 
    //
    be.FE.MODULES.toolbar = function (i) {
      var r = [];
      ...
      return {
        apply: function (e) {
          ...
          if (be(t).parents(".fr-img-caption").length) be(t).css("text-align", e);
          else {
      ...
      colorsText: ["#008000", "#00FF00", "#000080", "#2C82C9", "#800080", "#475577", "#CCCCCC", "#41A85F", "#00A885", "#800000", "#2969B0", "#553982", "#28324E", "#000000", "#808000", "#FBA026", "#EB6B56", "#E25041", "#A38F84", "#EFEFEF", "#FFFFFF", "#FFFF00", "#F37934", "#FF0000", "#B8312F", "#7C706B", "#D1D5D8", "REMOVE"],
      colorsBackground: ["#008000", "#00FF00", "#000080", "#2C82C9", "#800080", "#475577", "#CCCCCC", "#41A85F", "#00A885", "#800000", "#2969B0", "#553982", "#28324E", "#000000", "#808000", "#FBA026", "#EB6B56", "#E25041", "#A38F84", "#EFEFEF", "#FFFFFF", "#FFFF00", "#F37934", "#FF0000", "#B8312F", "#7C706B", "#D1D5D8", "REMOVE"],
      colorsStep: 7,
      colorsHEXInput: !0,
      ...
      function t(e) {
        e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function () {
          for (var e = null, t = 0; t < be.FE.INSTANCES.length; t++)
            if ((e = be.FE.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0)
      ...
      function i(e) {
        ...
        for (var r = 0; r < be.FE.INSTANCES.length; r++)
          ...
          else d.$el.find(".fr-marker").replaceWith(be.FE.MARKERS), d.selection.restore();
	...
	"Calibri": "Calibri",
      ...
      fontSize: ["8", "9", "10", "11", "12", "13", "14", "15", "16", "18", "20", "22", "24", "26", "28", "30", "36", "48", "60", "72", "96"],
      fontSizeSelection: !1,
     ...
     // imageCORSProxy: "https://cors-anywhere.froala.com",
      ...
      var f, l, d, p, s, n, u = "https://i.froala.com/upload",
        t = !1,
        r = 1,
        h = 2,
        g = 3,
      ...
      function C(e) {
        ...
        for (t = 0; t < n.length; t++)
          ...
          for (t = 0; t < s.length; t++) r.indexOf(s[t].getAttribute("src")) < 0 && c.events.trigger("image.removed", [be(s[t])]);
        if (s && e) {
          var o = [];
  ...
  be.FE.DEFAULTS.imageInsertButtons.push("imageManager"), be.FE.RegisterCommand("imageManager", {
    ...
    be.extend(be.FE.DEFAULTS, {
      ...
      function s(e, t) {
        ...
        else if (null == t)(s = (a = e.parent()).offset().top + a.outerHeight()) < (d = e.offset().top + e.outerHeight()) && (s = (a = be(a).parent()).offset().top + a.outerHeight()), n = d + Math.min(Math.abs(s - d) / 2, p.opts.lineBreakerOffset), i = a.outerWidth(), r = a.offset().left;
        else {
          a = e.parent();
    ...
    be.FE.PLUGINS.quickInsert = function (o) {
      ...
      tableColors: ["#008000", "#00FF00", "#000080", "#2C82C9", "#800080", "#475577", "#CCCCCC", "#41A85F", "#00A885", "#800000", "#2969B0", "#553982", "#28324E", "#000000", "#808000", "#FBA026", "#EB6B56", "#E25041", "#A38F84", "#EFEFEF", "#FFFFFF", "#FFFF00", "#F37934", "#FF0000", "#B8312F", "#7C706B", "#D1D5D8", "REMOVE"],
      tableColorsStep: 7,
      tableCellStyles: {
      ...
      function O(t, n) {
        if (be(t).is(n)) L(), be(t).addClass("fr-selected-cell");
        else {
          x(), T.edit.off();
          var r = S(),
            i = R(t, r),
          ...
          for (var s = o.min_i; s <= o.max_i; s++)
            for (var l = o.min_j; l <= o.max_j; l++) be(r[s][l]).addClass("fr-selected-cell")
        }
      }
        ...
        deleteColumn: function () {
          ...
          if (0 < e.length) {
            ...
            if (0 === a.min_j && a.max_j == i[0].length - 1) h();
              ...
              var o = 0;
              for (t = 0; t < i.length; t++)
                for (n = 0; n < i[0].length; n++)(r = be(i[t][n])).hasClass("fr-selected-cell") || (r.data("old-width", r.outerWidth() / e.outerWidth() * 100), (n < a.min_j || n > a.max_j) && (o += r.outerWidth() / e.outerWidth() * 100));
        ...
        splitCellHorizontally: function () {
          if (1 == Q().length) {
            ...
            if (1 < r) {
              ...
              for (var l = a.row + s, d = 0 === a.col ? a.col : a.col - 1; 0 <= d && (i[l][d] == i[l][d - 1] || 0 < l && i[l][d] == i[l - 1][d]);) d--; - 1 == d ? be(n.find("tr").not(n.find("table tr")).get(l)).prepend(o) : be(i[l][d]).after(o)
            } else {
      ...
      var s, c, p, u, r, n, d = "https://i.froala.com/upload",
        l = 2,
        h = 3,
        g = 4,
        m = 5,
      ...
      function k() {
        ...
        if (r)
          for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("src")) < 0 && f.events.trigger("video.removed", [be(r[e])]);
        r = t
      }
